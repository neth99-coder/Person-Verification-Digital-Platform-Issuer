                    ...
                    <MDBCard className='my-5'>
                        <MDBCardBody className='p-5 pb-0'>
                            ...
                            <MDBCard background='primary' className='text-white mb-6'>
                                ...
                                <MDBCardBody onClick={() => { window.location.href = '/id-requests' }}>
                                    <MDBCardTitle style={{ textAlign: 'center' }}>View ID Requests</MDBCardTitle>

                                </MDBCardBody>

                            </MDBCard>
                            <MDBCard background='primary' className='text-white mb-6'>
                                <MDBCardBody onClick={() => { window.location.href = '/ver-requests' }}>
                                    <MDBCardTitle style={{ textAlign: 'center' }}>View Verifier Requests</MDBCardTitle>
